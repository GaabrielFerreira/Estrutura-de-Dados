/*Titulo: Altera Valores de Venda (Vetor Estatico)
  Autores: Gabriel Ferreira RA: 236085
  Ultima modificacao: 18/02/2025 - 20:27
  Descricao: O código recebe os dados do arquivo Produtos-10.csv em um vetor estatico de 10 posicoes, exibe o vetor e depois utilizando a funcao alteraCusto, altera o valor de venda dos produtos para 1.5 x valor de custo (apenas no vetor, sem reescrever no arquivo), porem, se o valor de custo for 0, o usuario escolhe o valor de venda*/
